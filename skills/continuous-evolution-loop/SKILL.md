...
description: "MANDATORY. Use for ANY non-trivial project. Enforces an infinite self-improvement loop of testing and refinement until the Reference Bar is surpassed."
---
...
```mermaid
graph TD
    A[Cycle 1: Core Architecture & Invariant Foundation] -->|Multi-State Empirical Pass| B[Cycle 2: Deep Interaction & Concurrency Polish]
    B -->|Self-Critique & Breakthrough Ingestion| C[Cycle 3: High-Scale Innovation & Telemetry Synthesis]
    C -->|Zero-Trust Final Telemetry Gate| D[Universal Production Release Q >= 9.0]
```
