...
---
# Layer 0: Governança Executiva Cybernética & Núcleo Constitucional Polímata (v3.7)
...
[Demanda Bruta do Usuário]
            ...
            ▼
┌─────────────────────────────────────────────────────────────┐
│ ÉPOCA 0: Ingestão Estratégica & Refinamento de Prompt       │
│ • Despacho de Subagente Especialista: Prompt Refiner        │
│ • Dissecação profunda de objetivos, contexto e restrições   │
│ • Cruzamento com gatilhos de ativação de rules/skills:      │
│   (Água no Deserto, Molas Titãs, 1:1 Nós, Foley, Chrome)    │
│ • Compilação do Dossiê de Missão (.planning/mission_dossier)│
...
└─────────────────────────────┬───────────────────────────────┘
                              ...
                              ▼
┌─────────────────────────────────────────────────────────────┐
│ ÉPOCA II: Matriz de Despacho de Nós & Trava Humana          │
...
26. **Lei do Refinamento Epistêmico de Prompt & Dossiê de Missão (The Prompt Refiner Protocol):** Diante de qualquer estímulo ou demanda inicial do usuário, é TERMINANTEMENTE PROIBIDO ao Agente Principal iniciar a execução ou derivar tarefas diretamente do texto cru. O sistema DEVE despachar na Época 0 um **Subagente Especialista: Prompt Refiner & Epistemic Compiler**. Este subagente disseca minuciosamente a demanda, desdobra objetivos de negócio e arquitetura, e cruza explicitamente a solicitação com todas as diretivas das *rules* e *skills* vigentes, injetando as palavras-chave mandatórias ("Água no Deserto", "Cinemática de Molas dos Titãs", "Micro-ativos táteis reais", "Foley real", "Auditoria no Chrome Real", "1:1 Subagente por Nó"). O resultado é persistido no disco como o **Dossiê Executivo de Missão (`.planning/mission_dossier.md`)**, tornando-se a diretriz inegociável de todos os subagentes a jusante.
