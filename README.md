<div align="center">
  <img src="assets/banner.jpg" alt="AGI Antigravity Banner" width="100%">
  ...
  <p>
    <img src="https://img.shields.io/badge/Antigravity-Plugin-blueviolet?style=for-the-badge&logo=google" alt="Antigravity Plugin">
    <img src="https://img.shields.io/badge/Cognition-System%202%20AGI-brightgreen?style=for-the-badge" alt="System 2 AGI">
    <img src="https://img.shields.io/badge/Architecture-Deterministic%20Loop-orange?style=for-the-badge" alt="Deterministic Loop">
...
```mermaid
graph TD
    A[🧠 AGI Core Engine] --> B[Sector 1: Metacognition & Governance]
    A --> C[Sector 2: Adversarial Debate & Falsification]
    A --> D[Sector 3: Research & Domain Grounding]
    A --> E[Sector 4: Software Engineering & Multimodal Synthesis]
    A --> F[Sector 5: Swarm Topology & Memory]

    style A fill:#4F46E5,stroke:#312E81,stroke-width:2px,color:#fff
    style B fill:#0EA5E9,stroke:#0369A1,stroke-width:1px,color:#fff
    style C fill:#EF4444,stroke:#991B1B,stroke-width:1px,color:#fff
    style D fill:#10B981,stroke:#065F46,stroke-width:1px,color:#fff
    style E fill:#8B5CF6,stroke:#5B21B6,stroke-width:1px,color:#fff
